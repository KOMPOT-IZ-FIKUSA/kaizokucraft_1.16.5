...
public class SAbilityTurnOff {


    public int abilityInInventoryIndex;

    public SAbilityTurnOff(int abilityInInventoryIndex) {
        this.abilityInInventoryIndex = abilityInInventoryIndex;
    }

    public static void encode(SAbilityTurnOff packet, PacketBuffer buf) {
        buf.writeInt(packet.abilityInInventoryIndex);
    }

    public static SAbilityTurnOff decode(PacketBuffer buf) {
        return new SAbilityTurnOff(buf.readInt());
    }

    public static void handle(SAbilityTurnOff packet, Supplier<NetworkEvent.Context> ctx) {
