...
import com.deadfikus.kaizokucraft.client.render.VoidEntityRenderer;
...
public class ClientRegister {
    ...
    private void registerEntityRenderers() {
        ...
        RenderingRegistry.registerEntityRenderingHandler(KaizokuEntityTypes.LIVING_COLLISION.get(), VoidEntityRenderer::new);
